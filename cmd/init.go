...
- [Sharing Projects Read-Only (cg share)](sharing-projects.md) — what Claude must and must not do when asked to share, export or publish a project: audiences, findings, the owner-run first publish, and republish consent.
